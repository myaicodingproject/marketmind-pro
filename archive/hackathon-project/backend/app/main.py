...
async def generate_report_pdf(report_id: str, request: Dict[str, Any], background_tasks: BackgroundTasks):
...
async def get_pdf_status(report_id: str, job_id: str):
...
async def download_pdf(report_id: str, job_id: str):

...
class SectionType(str, Enum):
    """Report section types matching institutional research format"""
...
class ReportSection(BaseModel):
    ...
    section_type: Literal["executive_summary", "company_history", "leadership_analysis", 
                         "business_model", "financial_analysis", "valuation_analysis",
                         "market_analysis", "risk_assessment", "investment_thesis"] = Field(..., description="Section type")
...
class EnhancedReport(BaseModel):
    ...
    def validate_sections(cls, v):
        required_sections = {"executive_summary", "company_history", "leadership_analysis", 
                           "business_model", "financial_analysis", "valuation_analysis", 
                           "market_analysis", "risk_assessment", "investment_thesis"}

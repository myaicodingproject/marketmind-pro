...
from services.polishing_service import polishing_service
from services.content_parser_service import ContentParserService
...
class EnhancedReportService:
    ...
    async def process_raw_section(
        ...
        try:
            ...
            parsed_section = content_parser_service.parse_section(
                raw_content
            )

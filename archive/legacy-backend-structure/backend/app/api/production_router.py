...
Centralized routing for all API endpoints with JWT Authentication
"""
...
async def generate_report(
    ...
    try:
        ...
        # Generate unique report ID with user context
...
async def process_report_generation(report_id: str, request: ReportRequest):
    ...
    try:
        ...
        if request.include_pdf:
            ...
            pdf_path = generate_professional_pdf(request.ticker, report_data)

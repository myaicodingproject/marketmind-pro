...
import tempfile
import os
from content_pipeline import CONTENT_PIPELINE, clean_report_data
...
class ContentCleaner:
    ...
    def __init__(self):
        ...
        self.removal_patterns = [
            ...
            r'\+ \d+:\s*\+ \d+:',  # Line numbers like "+ 206: + 207:"
            r'\+ \d+:\s*-',  # Line numbers like "+ 208: -"
            r'\+ \d+:\s*',  # Any line starting with + number:
            r'^\s*\d+:\s*\+',  # Line numbers at start like "206: +"
    ...
    def clean_content(self, content: str) -> str:
        ...
        # First, remove the specific line number patterns you're seeing
...
'''
    ...
    def generate_pdf(self, report_data: Dict[str, Any], output_path: str) -> str:
        ...
        try:
            # Clean report data using the centralized pipeline

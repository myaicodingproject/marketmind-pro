...
## Mission
Perform comprehensive technical code review on recently changed files using Claude's systematic approach, focusing on real bugs, security issues, and code quality problems.
...
Start by examining:
- Steering documents in `.kiro/steering/` for project standards and conventions
- README.md
...
5. **Adherence to Codebase Standards and Existing Patterns**
   - Adherence to standards documented in steering documents
